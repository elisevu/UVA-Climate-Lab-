...
nc55 = Ncdf('qv_2m_monthly_mean_d02_2055-2064.nc', 'r')
print(nc)
...
plt.subplots_adjust(top=1, bottom=0, right=1, left=0,
                    hspace=0, wspace=0)
plt.margins(0, 0)
map.pcolormesh(x, y, diff55[0, :, :], cmap='RdBu_r', vmax = 0.00250, vmin = -0.00250)
...
for b in range(0, 31):
    ...
    cb.remove();
    plt.draw();
    plt.savefig("qv_2m_monthly_mean_d02_2055-2064_%s.png" % b, transparent='True',
