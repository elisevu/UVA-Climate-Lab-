...
for b in range(0, 24):
    map.pcolormesh(x, y, diff[b, :, :], cmap='bwr', vmin=-2.5, vmax=2.5)
    #plt.title('2m Temperature on %s' % datevar[b])
    plt.savefig("E:/elise/Documents/UVA-Climate-Lab-/diurnal/precip_diurnal_diff_2090-2099_%s.png" % b, transparent='True',
                bbox_inches='tight', pad_inches=0)
    print('saved %s' % b)
plt.colorbar(label="Difference in Rainfall Rate (mm/hr)")
plt.savefig("E:/elise/Documents/UVA-Climate-Lab-/diurnal/precip_diurnal_diff_2090-2099_KEY.png", transparent='True',
            bbox_inches='tight', pad_inches=0)
print('saved key')